...
router.get('/', function(req, res, next) {
    ...
    res.render('signup', { user: req.user }); //display user.hbs
});
...
router.post('/createEvent', loggedIn, function(req, res) {
    client.query('INSERT INTO events (username, event, date, description) VALUES($1, $2, $3, $4)', [req.user.username, req.body.event, req.body.date, req.body.paragraph], function(err, result) {
        if (err) {
